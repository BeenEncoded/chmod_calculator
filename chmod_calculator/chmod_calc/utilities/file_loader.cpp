...
namespace utility
{
	/*template void                            save      <type>(type& t, const boost::filesystem::path& folder);
	template std::set<ID_T>                  ids       <type>(const boost::filesystem::path& folder);
	template std::vector<type> load_all  <type>(const boost::filesystem::path& folder);
	template void                            remove    <type>(const ID_T& id, const boost::filesystem::path& folder);
	template type              load      <type>(const ID_T& id, const boost::filesystem::path& folder);
	template std::vector<type> load_basic<type>(const boost::filesystem::path& folder);*/
